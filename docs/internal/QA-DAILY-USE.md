# QA Daily-use — ручной регресс (v0.29.0)

Чеклист для проверки ежедневного использования IDE. Выполнять на свежей установке или после `settings.json` → сброс по умолчанию.
...
**Версия документа:** v0.29.0 / stabilization roadmap (фазы 0–10 Done)
